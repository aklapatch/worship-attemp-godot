...
func make_new_slide():
	...
	var new_text_button = TextureRect.new()
	new_text_button.size_flags_horizontal = SIZE_EXPAND_FILL
	new_text_button.expand = true
	new_text_button.stretch_mode = TextureRect.STRETCH_KEEP_ASPECT
	...
	new_text_button.texture = child_w_texture.texture
	...
	new_show_button.size_flags_horizontal = SIZE_EXPAND_FILL
	
	var new_edit_button = Button.new()
	new_edit_button.text = "Edit"
	new_edit_button.size_flags_horizontal = SIZE_EXPAND_FILL
	new_edit_button.set_script(edit_button_script)
	
	var new_del_button = Button.new()
	new_del_button.text = "Delete"
	new_del_button.size_flags_horizontal = SIZE_EXPAND_FILL
	
	var new_hbox = HBoxContainer.new()
	new_hbox.add_child(new_show_button)
	new_hbox.add_child(new_edit_button)
	new_hbox.add_child((new_del_button))
